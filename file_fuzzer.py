...
class file_fuzzer:
    ...
    def __init__(self, exe_path, ext, notify):
        ...
        self.test_cases = ["%s%n%s%n%s%s", "\xff", "\x00", "A"]
    ...
    def file_picker(self):
        ...
        shutil.copy("example\\%s" % file, "test.%s" % self.ext)
    ...
    def mutate_file(self):
        ...
        test_case = self.test_cases[random.randing(0, len(self.test_cases)-1)]
...
if __name__ == "__main__":
    ...
    try:
        opts, argo = getopt.getopt(sys.argc[1:], "e:x:n")
